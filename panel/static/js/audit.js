...
const ACTION_NAMES = {
  ...
  "client.links.reveal": "Ссылки клиента показаны",
  ...
  "routing.exit.create": "Создан свой выход",
  "routing.exit.import": "Свой выход импортирован из ссылки",
  "routing.exit.update": "Свой выход изменён",
  "routing.exit.enable": "Свой выход включён",
  "routing.exit.disable": "Свой выход выключен",
  "routing.exit.delete": "Свой выход удалён",
  "routing.exit.test": "Проверка своего выхода",
  "fleet.exit.test": "Центр проверил свой выход на узле",
