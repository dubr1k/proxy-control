...
**Бета-выпуски (v0.2.0-beta.1, v0.3.0-beta.1).** `install-bootstrap` отклоняет
...
распакованного архива), и именно так поставлены v0.2 и v0.3:
