...
**Бета-выпуски (v0.2.0-beta.1 … v0.5.0-beta.1).** `install-bootstrap` отклоняет
...
распакованного архива), и именно так поставлены v0.2, v0.3, v0.4 и v0.5:
...
scripts/install-release.sh --version 0.5.0-beta.1 --sha256 <lab-sha256 из заметки о выпуске>
```
...
боевом узле в объёме своих релизных заметок. Не заявляются как завершённые: мост в 3x-ui,
