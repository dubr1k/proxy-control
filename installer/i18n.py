...
_CATALOG: dict[Locale, dict[str, str]] = {
    Locale.EN: {
        ...
        "router": "Install the Xray-router (Xray-linux-64.zip is staged in /var/lib/proxy-control)",
    ...
    Locale.RU: {
        ...
        "router": "Установить Xray-router (архив Xray-linux-64.zip найден в /var/lib/proxy-control)",
