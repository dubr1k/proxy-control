...
_CATALOG: dict[Locale, dict[str, str]] = {
    Locale.EN: {
        ...
        "router": "Install the Xray-router (pinned Xray-core 26.3.27; the archive is fetched unless staged in /var/lib/proxy-control)",
        ...
        "panel_password": "Panel password (blank to generate one)",
    ...
    Locale.RU: {
        ...
        "router": "Установить Xray-router (закреплённый Xray-core 26.3.27; архив скачивается сам, если не положен в /var/lib/proxy-control)",
        ...
        "panel_password": "Пароль панели (пусто — создать автоматически)",
